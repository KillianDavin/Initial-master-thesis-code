...
### Isolating desired final consumption industries - Agrifood sectors ###

Desired_final_demand_categories = pd.DataFrame(Y_RMRIO.loc[idx[:, ['Paddy rice', 'Wheat', 'Cereal grains nec', 'Vegetables, fruit, nuts', 'Oil seeds',
...
Y_RMRIO.loc[:,:] = 0.0
Y_RMRIO.loc[idx[:, ['Paddy rice', 'Wheat', 'Cereal grains nec', 'Vegetables, fruit, nuts', 'Oil seeds',
                  'Sugar cane, sugar beet', 'Plant-based fibers', 'Crops nec', 'Cattle', 'Pigs', 'Poultry',
                  'Meat animals nec', 'Animal products nec', 'Raw milk',
                  'Fish and other fishing products; services incidental of fishing (05)', 'Food products nec',
                  'Beverages', 'Sugar', 'Fish products', 'Dairy products',
...
str(mrio)
mrio.calc_all()
mrio.save_all('../results/agrifood_final_demand')
...
#D_cba_biod.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Biodiversity Footprint/EXIO3/BF_D_cba_2010_EORA_EXIO_Agrifood_Y_categories.csv')
...
#D_pba_biod.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Biodiversity Footprint/EXIO3/BF_D_pba_2010_EORA_EXIO_Agrifood_Y_categories.csv')
...
#D_imp_biod.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Biodiversity Footprint/EXIO3/BF_D_imp_2010_EORA_EXIO_Agrifood_Y_categories.csv')
...
#D_exp_biod.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Biodiversity Footprint/EXIO3/BF_D_exp_2010_EORA_EXIO_Agrifood_Y_categories.csv')
