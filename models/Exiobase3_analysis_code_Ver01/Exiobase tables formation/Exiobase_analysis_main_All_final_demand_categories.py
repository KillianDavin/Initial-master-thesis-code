...
##################################################################################################################################################################################################################
    ...
    ##################################################################################################################################################################################################################
        ...
        '''With a new  S table and S_Y table, all other tables are reset to the co-efficients
    ...
    ##################################################################################################################################################################################################################
        ...
        D_cba.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_cba_2010_LCIA_aggregated_All_Y_categories.csv')
        ...
        D_pba.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_pba_2010_LCIA_aggregated_All_Y_categories.csv')
        ...
        D_imp.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_imp_2010_LCIA_aggregated_All_Y_categories.csv')
        ...
        D_exp.to_csv('C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_exp_2010_LCIA_aggregated_All_Y_categories.csv')
        import os
        ...
        D_cba = pd.DataFrame(
            D_cba.loc[:, idx[:, ['Paddy rice', 'Wheat', 'Cereal grains nec', 'Vegetables, fruit, nuts', 'Oil seeds',
                    ...
                    'Products of meat cattle', 'Products of meat pigs', 'Products of meat poultry', 'Meat products nec',
                    'products of Vegetable oils and fats', 'Processed rice']]])  # Seggregating final consumer household demand
        myfile = 'C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_cba_' + year + '_LCIA_disaggregated_All_Y_categories.csv'
        D_cba.to_csv(myfile)

        myfile = 'C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_pba_' + year + '_LCIA_disaggregated_All_Y_categories.csv'
        ...
        D_imp = pd.DataFrame(
            D_imp.loc[:, idx[:, ['Paddy rice', 'Wheat', 'Cereal grains nec', 'Vegetables, fruit, nuts', 'Oil seeds',
                    ...
                    'Products of meat cattle', 'Products of meat pigs', 'Products of meat poultry', 'Meat products nec',
                    'products of Vegetable oils and fats', 'Processed rice']]])  # Seggregating final consumer household demand
        myfile = 'C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_imp_' + year + '_LCIA_disaggregated_All_Y_categories.csv'
        D_imp.to_csv(myfile)
        ...
        myfile = 'C:/Users/Cillian/PycharmProjects/Master-Thesis/data/processed/Pressure Footprint/EXIO3/PF_D_exp_' + year + '_LCIA_disaggregated_All_Y_categories.csv'
        D_exp.to_csv(myfile)
