...
class rmrio_import():
    ...
    def __init__(
            self,
            rmrio_file_path="C:/Users/Cillian/PycharmProjects/Master-Thesis/data/Raw/EXIO_EORA_HYBRID/Year_2010_RMRIO/rmrio-data",
            rmrio_year=2015
    ):
        """Init.
        ...
        self.region_idx = mat73.loadmat(
            ...
            "Labels_RMRIO/Labels_Countries_RMRIO.mat"
        )
        ...
        self.sector_idx = mat73.loadmat(
            f"{self.rmrio_file_path}/"
            "Labels_RMRIO/Labels_Sectors_RMRIO.mat"
        )
        ...
        self.extension_idx = mat73.loadmat(
            f"{self.rmrio_file_path}/"
            "Labels_RMRIO/Labels_Extensions_RMRIO.mat"
        )
        ...
        self.y_idx = mat73.loadmat(
            f"{self.rmrio_file_path}/"
            "Labels_RMRIO/Labels_FinalDemand_RMRIO.mat"
        )
        ...
        self.idx = mat73.loadmat(
            f"{self.rmrio_file_path}/"
            "Labels_RMRIO/Labels_Production_RMRIO.mat"
        )
