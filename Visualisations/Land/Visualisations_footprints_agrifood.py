...
print(list(Land_Agg_BF_D_cba_con_approach.index))
...
print(Land_Dissag_BF_D_cba_con_approach['Total Impacts'])
print(Land_Agg_BF_D_cba_con_approach['Total Impacts'])
Footprint_disparity_df['difference'] = pd.DataFrame((Land_Dissag_BF_D_cba_con_approach['Total Impacts'] - Land_Agg_BF_D_cba_con_approach['Total Impacts'])*100/ Land_Agg_BF_D_cba_con_approach['Total Impacts'])
...
ax2.set_ylim(-80, 80)
ax2.set_xlim(-0.8, len(Land_Dissag_BF_D_cba_con_approach.index))
